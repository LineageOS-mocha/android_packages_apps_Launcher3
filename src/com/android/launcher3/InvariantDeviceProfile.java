...
public class InvariantDeviceProfile {
    ...
    InvariantDeviceProfile(Context context, String n, float w, float h, int r, int c, int cd, int fr,
            int fc, int maapc, float is, float its, int hs, float his, int dlId) {
        name = n;
        minWidthDps = w;
        minHeightDps = h;
        numRows = r;
    ...
    private void setGridSize(Context context) {
        ...
        String defaultGridSize = "default";

        String size = prefs.getString(KEY_GRID_SIZE, defaultGridSize);
        String properSize;
        switch (size) {
            case "default":
                properSize = defaultGridSize;
                break;
            case "custom":
                properSize = prefs.getString(KEY_GRID_CUSTOM, defaultGridSize);
                break;
            default:
                properSize = size;
                break;
